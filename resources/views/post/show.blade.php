    ...
    <div class="container-fluid">
        <form class="form-horizontal" action="{{route('posts.store')}}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" value="{{$data->title}}" class="form-control" id="exampleInputEmail1" placeholder="">
            </div>
            @if (count($errors) > 0)
            ...
            <div class="form-group col-md-4">
                ...
                <select name="category_id" class="form-control " id="">
                    ...
                    <option value="1" >{{$data->slug}}</option>
                </select>
            ...
            <div class="form-group">
                ...
                <div id="editormd" style="min-height: 200px;">
                    {{--<textarea class="editormd-markdown-textarea" name="markdown">{{$data->markdown}}</textarea>--}}

                    <!-- html textarea 需要开启配置项 saveHTMLToTextarea == true -->
                    <textarea class="editormd-html-textarea" name="content">{{$data->content}}</textarea>
